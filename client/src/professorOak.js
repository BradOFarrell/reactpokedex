...
The main purpose of this helper function is to abstract all logic that is
specific to the game mechanics of Pokemon into one file. This keeps the UI
from having to deal with Pokemon-related logic.
...
class Oak{
    ...
    getTypeColor(typeString){
        let output = "#333333";
        for(let i = 0; i < types.length; i++){
            if(types[i][0] === typeString)
            output = typeColors[i]
        }
        return output;
    }
